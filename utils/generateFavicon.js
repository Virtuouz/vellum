...
async function generateFavicon() {
  ...
  if (!faviconPath) {
    ...
    faviconPath = siteConfig.logoLightPath ? checkFileExists(path.join("src",siteConfig.logoLightPath)) : "";
  }
  if (!faviconPath) {
    console.warn("Light Logo path invalid or missing, falling back to dark logo.");
    faviconPath = siteConfig.logoDarkPath ? checkFileExists(path.join("src",siteConfig.logoDarkPath)) : "";
  }
  if (!faviconPath) {
    console.warn("Dark logo path invalid or missing, using default favicon.");
